...
class InputPanel(QtWidgets.QWidget):
    ...
    def create_input_layout(self):
        ...
        visit_layout = self._create_textbox_with_label(
            QtWidgets.QHBoxLayout(), self.visit_path, "Visit", ""
        )
    ...
    def _create_dataset_layout(self):
        ...
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QHBoxLayout(), self.dataset, "Dataset", ""
            )
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QHBoxLayout(), self.prefix, "Prefix", ""
            )
        )
        return layout
    ...
    def _create_params_layout(self):
        ...
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.num_images, "No. images", 50
            ),
            0,
            0,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.time_image, "Time image (s)", 0.2
            ),
            0,
            1,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.image_width, "Image width (deg)", 0.2
            ),
            0,
            2,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.det_dist, "Det distance (mm)", 117.53
            ),
            0,
            3,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.two_theta, "2 theta (deg)", 0
            ),
            0,
            4,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.rotation_start, "Phi start (deg)", 0
            ),
            1,
            0,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.well_start, "Well start", 1
            ),
            1,
            1,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.well_end, "Well end", 10
            ),
            1,
            2,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.series_length, "Series length", 1
            ),
            1,
            3,
        )
        layout.addLayout(
            self._create_textbox_with_label(
                QtWidgets.QVBoxLayout(), self.transmission, "Transmission (%)", 5
            ),
            1,
            4,
        )
    ...
    def _create_textbox_with_label(
        self,
        text_layout: QtWidgets.QBoxLayout,
